...
# ===============================
# 3. Dataset Class (31 windows with scaling)
# ===============================
class EEGDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        chunk[30] *= 1.5 * ((self.data[idx]["char_idx_in_sentence"] / 24) + 1)  # Emphasize the prediction timestep
...
def plot_loss_curve(loss_history, convergence_epoch=None):
    ...
    plt.title('Training Loss vs Epoch (31 Windows)', fontsize=14, fontweight='bold')
    plt.legend(fontsize=10)
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
    
    plot_path = 'training_loss_curve_31windows.png'
...
if __name__ == "__main__":
    print("\n" + "=" * 80)
    print("TRAINING (31 Windows with Last Window Scaling)")
    print("=" * 80)
